<footer class="py-10 bg-white text-black">
    <div class="max-w-[1200px] mx-auto px-4 grid lg:grid-cols-2">
        <div class="space-y-2">
            <h2 class="font-bold text-4xl">Touch Me In</h2>
            <a href="mailto:wintkhantlin@gmail.com" class="text-xl hover:underline">wintkhantlin@gmail.com</a>
        </div>
        <div class="flex flex-col justify-end lg:items-end lg:mt-0 mt-10">
